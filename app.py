...
Original file is located at
    https://colab.research.google.com/drive/1aMvBcTU9ptYSDJCGNoNF5e4P_qAG57uY
"""
...
# Welcome subtitle
st.markdown("""
<div style='text-align: center; font-size: 22px; font-weight: bold; padding-top: 10px; margin-bottom: 25px; color: #F0F0F0;'>
...
if historical_total > 0:
    ...
    st.success(f"Based on the graph, EV adoption in **{county}** is expected to show a **{trend}** of {forecast_growth_pct:.2f}%.")
else:
